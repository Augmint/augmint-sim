...
function init() {
    ...
    simulation.patchAugmintBalances({
        interestEarnedPool: 500
    });
    simulation.addActors({
        reserve: { type: 'Reserve', balances: { acd: 10000, eth: 0 } },
        alwaysLocker: { type: 'AlwaysLocker', balances: { eth: 50000 } } // maxAcdToConvert defined in always.locker.js
    });
    // simulation.addActors({
