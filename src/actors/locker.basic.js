...
class LockerBasic extends Actor {
  ...
  executeMoves(state) {
    ...
    if (this.locks.length === 0) {
      ...
      this.aimingToLockAmount = Math.round(Math.min(acdAvailable, this.params.WANTS_TO_LOCK_AMOUNT) * 10000) / 10000;
    }
    ...
    if (this.wantToLock && (this.lastAugmintInterest != augmintInterest || this.lastMarketInterest != marketInterest)) {
